#define PORTA_BASE_ADDRESS 0x 0x40010800

#define PORTA_CRL *((u32*)(PORTA_BASE_ADDRESS0x00))
#define PORTA_CRH *((u32*)(PORTA_BASE_ADDRESS0x04))
#define PORTA_IDR *((u32*)(PORTA_BASE_ADDRESS0x08))
#define PORTA_ODR *((u32*)(PORTA_BASE_ADDRESS0x0c))
#define PORTA_BSRR *((u32*)PORTA_BASE_ADDRESS+0x10))
#define PORTA_BRR *((u32*)(PORTA_BASE_ADDRESS0x14))
#define PORTA_LCKR *((u32*)PORTA_BASE_ADDRESS+0x18))



#define PORTB_BASE_ADDRESS 0x 0x40010800
...
#define PORTC_BASE_ADDRESS 0x 0x40010800
